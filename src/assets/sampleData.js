export const input = {
    ...
    "summaries": [
      ...
      {
        "id": 9,
        "summary": "The Book in Three Sentences: Know when to fight and when not to fight: avoid what is strong and strike at what is weak. Know how to deceive the enemy: appear weak when you are strong, and strong when you are weak. Know your strengths and weaknesses: if you know the enemy and know yourself, you need not fear the result of a hundred battles."
      },
      {
        "id": 10,
        "summary": "The Book in Three Sentences: To become a better writer, you have to write more. Writing reveals the story because you have to write to figure out what you\u2019re writing about. Don\u2019t judge your initial work too harshly because every writer has terrible first drafts."
      },
      {
        "id": 11,
        "summary": "The Book in Three Sentences: Steve Martin was one of the most successful comedians of his generation. In his words, his career involved \u201c10 years spent learning, 4 years spent refining, and 4 years spent in wild success.\u201d This fantastic book provided beautiful insights not only into the details of his comedy act, but also into his early life and career development."
      },
      {
        "id": 12,
      ...
      {
        "id": 28,
        "summary": "The Book in Three Sentences: This book is a collection of transcriptions from a series of interviews between writer Calvin Tomkins and artist Marcel Duchamp. Duchamp believed strongly in doing work that was free from tradition and starting with as much of a blank slate as possible. He was also quite playful, worked slowly, and saw laziness as a good thing."
      },
      {
        "id": 29,
        "summary": "The Book in Three Sentences:\u00a0Avoiding loss should be the primary goal of every investor. The way to avoid loss is by investing with a significant margin of safety. A margin of safety is necessary because valuation is an imprecise art, the future is unpredictable, and investors are human and make mistakes."
      },
      {
        "id": 30,
        "summary": "The Book in Three Sentences: Hosting dinners with like-minded people is one of the most powerful way to build fantastic relationships in business and in life. You should think carefully about who you invite to these meals and look for uncommon commonalities that make it more likely the guests will resonate with one another. Be the gatekeeper of your network and assume responsibility for the people you surround yourself with in life."
      },
      {
        "id": 31,
        "summary": "The Book in Three Sentences:\u00a0The most successful path to mastering anything is to practice for the sake of the practice itself, not for the result. All significant learning is composed of brief spurts of progress followed by long periods of work where if feels as if you are stuck on a plateau.\u00a0There are no experts\u2013only learners."
      },
      {
        "id": 32,
        "summary": "The Book in Three Sentences:\u00a0You can\u2019t do the same things others do and expect to outperform. The most dependable way to outperform the market is to buy something for less than its value. It is price, not quality that determines value: high-quality assets can be risky, and low-quality assets can be safe."
      },
      {
        "id": 33,
        "summary": "The Book in Three Sentences: It is more important to live fully than to live in a straight line. The surest gauge of the impact a life makes is how many other lives it touches. Nothing in life looks the same once you truly understand that you are not exempt from death."
      },
      {
        "id": 34,
        "summary": "The Book in Three Sentences: The two classic drivers of human development are nature (genes) and nurture (environment). Many people mistakenly believe nurture only refers to how parents raise their children. Although children do learn things from their parents, they learn far more from their peers. The world that children share with their peer group is what shapes their behavior, modifies the characteristics they were born with, and determines the sort of people they will be when they grow up."
      },
      {
        "id": 35,
        "summary": "The Book in Three Sentences: Oliver Sacks was a brilliant physician and a fantastic writer. He lived a full life that included dealing with criticism over being gay, attending medical school at Oxford University, experimenting with heavy drug use, traveling the United States and Canada by motorcycle, suffering life-threatening injuries, squatting a California state record of 600 pounds, and being honored by the Queen of England for his many books and storied career as a physician. Sacks is a symbol of the importance of writing, the power of exploration and inquisitiveness, and the need for empathy."
      },
      {
        "id": 36,
        "summary": "The Book in Three Sentences:\u00a0We all fear death, but life is long if you know how to use it. Putting things off is the biggest waste of life: it snatches away each day as it comes, and denies us the present by promising the future: live immediately.\u00a0In any situation in life you will find delights and relaxations and pleasures if you are prepared to make light of your troubles and not let them distress you."
      },
      {
        "id": 37,
        "summary": "The Book in Three Sentences: The human brain is wired for inattention and inertia. As a result, many people already have good intentions, but don\u2019t follow through due to forgetfulness, procrastination, or a general lack of awareness. We can bridge the gap between our intentions and our behavior by using strategies to lock in our future behavior like active choice, pre-commitment, good design, reframing, and simplicity."
      },
      {
        "id": 38,
        "summary": "The Book in Three Sentences: All of life is practice in one form or another. Actively practicing something is very different from passively learning. You will never reach a level of performance that feels complete, so learn to love the art of practicing your skill."
      },
      {
        "id": 39,
      ...
      {
        "id": 53,
        "summary": "The Book in Three Sentences:\u00a0The memoir of Paul Kalanithi, a neurosurgeon at Stanford University, who is diagnosed with terminal lung cancer in his mid-thirties. Kalanithi uses the pages in this book to not only tell his story, but also share his ideas on how to approach death with grace and what it means to be fully alive."
      },
      {
        "id": 54,
        "summary": "The Book in Three Sentences: Letting go of what we know is hard, but essential for growth and improvement. The quicker you let go of old things, the sooner you can learn new skills and create a better future. When you change what you believe, you can change what you do."
      }
    ],
    "authors": [
      {
